...
import edu.umd.marbl.mhap.minhash.OneMinHashSearch;
import edu.umd.marbl.mhap.minhash.SequenceMinHashStreamer;
import edu.umd.marbl.mhap.minhash.SequenceMinHashes;
import edu.umd.marbl.mhap.utils.Utils;

public final class OneMhapMain extends AbstractSequenceSearchMain<OneMinHashSearch, SequenceMinHashes>
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		OneMhapMain main = new OneMhapMain(processFile, inFile, toFile, noSelf, subSequenceSize, numHashes, kmerSize,
	...
	public OneMhapMain(String processFile, String inFile, String toFile, boolean noSelf, int subSequenceSize,
	...
	@Override
	public OneMinHashSearch getMatchSearch(AbstractSequenceHashStreamer<SequenceMinHashes> hashStreamer) throws IOException
	{
		return new OneMinHashSearch(hashStreamer, this.numHashes, this.numMinMatches, this.numThreads, false,
	...
	@Override
	protected void outputFinalStat(OneMinHashSearch matchSearch)
	{
